...
about this. If you can't change the headers then you may use StreamSaver as a last
resource. FileSaver, streamsaver and others alike are mostly for client generated
...
<script>
  ...
  if (manual) {
    ...
    // (You could also use a transform stream that would sit between)
