...
var RigModel = /*#__PURE__*/function () {
  ...
  var _proto = RigModel.prototype;

  _proto.updateBounds = function updateBounds() {
  ...
  _proto.clone = function clone(keyframes) {
    keyframes = keyframes || this.keyframes;
    var clone = this.fromJSON(this.toJSON(keyframes));
    return clone;
  };

  _proto.getKeyframe = function getKeyframe(findKey, value) {
  ...
  _proto.editJoints = function editJoints(f) {
    var keyframes = Object.values(this.keyframes);
  ...
  _proto.editJoint = function editJoint(id, prop, unique) {
    var keyframes = Object.values(this.keyframes);
  ...
  _proto.addSubKeyframes = function addSubKeyframes(start, end) {
    if (timeline.graph) {
      var keys = Object.keys(this.keyframes);
  ...
  _proto.updateSubKeyframes = function updateSubKeyframes() {
    var keys = Object.keys(this.keyframes);
  ...
  _proto.setKeyframe = function setKeyframe(index, options) {
  ...
  _proto.deleteKeyframe = function deleteKeyframe(id) {
  ...
  _proto.updateKeyframe = function updateKeyframe(index, data) {
  ...
  _proto.addJoint = function addJoint(x, y, options) {
    options = options || {};
  ...
  _proto.selectJoint = function selectJoint(x, y) {
  ...
  _proto.removeJointById = function removeJointById(id) {
    var keys = Object.keys(this.keyframes);
    ...
    for (var i = 0; i < keys.length; i++) {
      ...
      if (joint) {
        ...
        if (joint.parent) {
          ...
          (_joint$parent$childre = joint.parent.children).push.apply(_joint$parent$childre, joint.children);
  ...
  _proto.removeJointByPosition = function removeJointByPosition(x, y) {
    if (!this.joints.length) return;
  ...
  _proto.computeKinematics = function computeKinematics(jointChain, inverse) {
    /*let doforward = [];
    let doinverse = [];
  ...
  _proto.updateSkin = function updateSkin(jointChain) {
  ...
  _proto.moveJointById = function moveJointById(id, x, y) {
  ...
  _proto.moveJoint = function moveJoint(x, y) {
    this.moveJointById(this.activeJoint.id, x, y);
  };

  _proto.getJoint = function getJoint(id) {
  ...
  _proto.toJSON = function toJSON(_keyframes, excludeImageSrc) {
  ...
  _proto["import"] = function _import(keyframes) {
  ...
  _proto.renderTo = function renderTo(ctx, options) {
    options = options || {};
