...
var Timeline = /*#__PURE__*/function () {
  ...
  _proto.storeSelectedKeyframe = function storeSelectedKeyframe() {
  ...
  _proto.markToX = function markToX(mark, ignoreLimits) {
  ...
  _proto.xToMark = function xToMark(x) {
    var scrollState = utils.map(this.scrollbar.left, 0, this.canvas.width, 0, this.canvas.width * this.scrollbar.zoomSensitivity);
    var scrollIndex = Math.round(utils.clamp(scrollState - this.hatchMark.spacing / 2, 0, Number.MAX_SAFE_INTEGER) / this.hatchMark.spacing);
    var snap = scrollState % this.hatchMark.spacing;
  ...
  _proto.addKeyboardEvents = function addKeyboardEvents() {
    var _this2 = this;
  ...
  _proto.addMouseEvents = function addMouseEvents() {
    var _this3 = this;
  ...
  _proto.addButtonEvents = function addButtonEvents() {
    var _this4 = this;
  ...
  _proto.updateState = function updateState(updateRig) {
  ...
  _proto.text = function text(_text, x, y, color, textAlign) {
    this.context.beginPath();
  ...
  _proto.createRect = function createRect(x, y, width, height, color, chamfer) {
    chamfer = chamfer || 0;
    this.context.beginPath();
  ...
  _proto.createLine = function createLine(x1, y1, x2, y2, color) {
    this.context.beginPath();
  ...
  _proto.createKeyframe = function createKeyframe(x, y, size, color) {
    this.context.beginPath();
  ...
  _proto.setCurrentMark = function setCurrentMark(index, updateRig) {
