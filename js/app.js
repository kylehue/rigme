...
!function (e) {
    ...
    _createClass(_class3, [{
      ...
      value: function addMouseEvents() {
        ...
        this.redraw(), addEventListener("mouseup", function () {
          ...
          if (e.target == _this5.canvas && 1 == e.which) {
          ...
          if (g = (t >= c - k && t <= c + k || t >= b - k && t <= b + k) && l, _this5.canvas.style.cursor = r || g ? "ew-resize" : "default", d) {
            ...
            for (var w = 0; w < _e11.length; w++) {
              var _n10 = h.keyframes[_e11[w]];
          ...
          if (n && t >= _this5.scrollbar.left && t <= _this5.scrollbar.right ? (_this5.scrollbar.color = o.render.timeline.scrollbar.color.hovered, _this5.redraw()) : (_this5.scrollbar.color = o.render.timeline.scrollbar.color["default"], _this5.redraw()), m) {
            ...
            if ("keyframe" == y) if (e) _this5.state._x = s.clamp(t, _this5.hatchMark.spacing / 2, _this5.canvas.width - _this5.hatchMark.spacing / 2), e.render.position.x = _this5.state._x, e.dragged = !0, e.render.color = o.render.keyframe.color.active;else {
              ...
              for (w = 0; w < _t7.length; w++) {
                var _i8 = h.keyframes[_t7[w]];
      ...
      value: function updateSkin(e) {
        ...
        for (var t = 0; t < e.length; t++) {
          var _i14 = e[t],
              ...
              _r10 = _i14.length,
              _s4 = 0;
          a.autofitSkin || _i14.skin.image && (_n18 = _i14.skin.image.width, _r10 = _i14.skin.image.height);
          var _l = _i14.skin.crop,
              _h2 = 0,
              _c2 = 0;
          _l && (_h2 = _l.to.x - _l.from.x, _c2 = _l.to.y - _l.from.y), _h2 > _c2 ? (_r10 = Number.MAX_SAFE_INTEGER, _n18 += _c2 / 2) : (_r10 += _h2 / 2, _n18 = Number.MAX_SAFE_INTEGER, _s4 = Math.PI / 2), _i14.skin.size = o.scaleSize(_h2, _c2, _n18, _r10), _i14.skin._sizeOriginal = {
            width: _h2,
            height: _c2
          }, _i14.skin.angleAuto = _s4;
          var d = 0,
              u = 0,
              p = 1,
              f = 1,
          ...
          if (_i14.skin.offset && (d = _i14.skin.offset.x || 0, u = _i14.skin.offset.y || 0, p = _i14.skin.offset.scaleX || 0, f = _i14.skin.offset.scaleY || 0, g = _i14.skin.offset.angle || 0), _i14.parent && _l) {
            _i14.skin.position = {
              x: (_i14.position.x + _i14.parent.position.x) / 2,
              y: (_i14.position.y + _i14.parent.position.y) / 2
            };
            var _e37 = [{
              x: _i14.skin.position.x + d - _i14.skin.size.width / 2,
              y: _i14.skin.position.y + u - _i14.skin.size.height / 2
            }, {
              x: _i14.skin.position.x + d + _i14.skin.size.width / 2,
              y: _i14.skin.position.y + u - _i14.skin.size.height / 2
            }, {
            ...
            for (var _i15 = 0, _e38 = _e37; _i15 < _e38.length; _i15++) {
              ...
              _t18.x = _t18.x + _e39.x * (p - 1), _t18.y = _t18.y + _e39.y * (f - 1);
            }

            for (var _i16 = 0, _e40 = _e37; _i16 < _e40.length; _i16++) {
              var _t19 = _e40[_i16];

              var _e41 = _i14.angle + _i14.skin.angleAuto + g,
        ...
        if (this.activeJoint = this.getJoint(e), this.activeJoint) {
          ...
          if (t && i && (this.activeJoint.position.dist(this.activeJoint.positionPrev) > 1 && (this._moved = !0, this.activeJoint.positionPrev.set(this.activeJoint.position.x, this.activeJoint.position.y)), this.activeJoint.position.set(t, i), "linear" == a.riggingMode)) {
            ...
            for (var n = 0; n < this.activeJoint.children.length; n++) {
              ...
              _e43.length = _e43.position.dist(this.activeJoint.position), _e43.angle = _e43.position.heading(this.activeJoint.position);
            }
          }
            ...
            if (_t22.skin && "object" == _typeof(_t22.skin.image) && _t22.skin.image.src && _t22.skin.position) {
              if (e.save(), e.translate(_t22.skin.position.x + n, _t22.skin.position.y + r), e.rotate(_t22.angle + _t22.skin.angleAuto), _t22.skin.offset) {
                var _i18 = _t22.skin.offset.x,
                    ...
                    _a5 = _t22.skin.offset.scaleY,
                    _o3 = _t22.skin.offset.angle;
                e.rotate(_o3), e.translate(_i18, _n21), e.scale(_r12, _a5);
              }
      ...
      value: function render(e) {
        ...
        if (l.graph) {
          ...
          e.save(), e.context.globalAlpha = .1, this.renderTo(e.context, {
            ...
            showBones: t
          }), e.restore(), this.keyframes[_a6] || (_a6 = _n22), this.renderTo(e.context, {
            frame: _a6,
            position: {
              x: this.bounds.min.x,
              y: this.bounds.min.y
  ...
  (function (e, i) {
    ...
    var E,
        ...
        M = (E = /[^.]+$/.exec(I && I.keys && I.keys.IE_PROTO || "")) ? "Symbol(src)_1." + E : "",
        _ = j.toString,
        q = T.hasOwnProperty,
        B = T.toString,
        F = RegExp("^" + _.call(q).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
        J = y ? f.Buffer : void 0,
        P = f.Symbol,
        O = f.Uint8Array,
    ...
    function le(e, t) {
      var i = Se(e) || function (e) {
        ...
        }(e) && q.call(e, "callee") && (!L.call(e, "callee") || B.call(e) == n);
      }(e) ? function (e, t) {
    ...
    function he(e, t, i) {
      var n = e[t];
      q.call(e, t) && xe(n, i) && (void 0 !== i || t in e) || (e[t] = i);
    }

    function ce(e, t) {
      for (var i = e.length; i--;) {
        if (xe(e[i][0], t)) return i;
      }
    ...
    function de(e, t, i, h, c, u, p) {
            ...
            switch (t) {
              ...
              case o:
                return function (e, t, i) {
                  return k(t ? i(x(e), !0) : x(e), v, new e.constructor());
                }(e, n, i);
              ...
              case s:
                return function (e, t, i) {
                  return k(t ? i(A(e), !0) : A(e), b, new e.constructor());
                }(e, n, i);
      ...
      var S = p.get(e);
      if (S) return S;
      if (p.set(e, f), !g) var E = i ? function (e) {
        return function (e, t, i) {
          var n = t(e);
      ...
      return function (e, t) {
        ...
        E && (n = e[r = n]), he(f, r, de(n, t, i, h, r, e, p));
      }), f;
    }

    function ue(e) {
      return !(!je(e) || (t = e, M && M in t)) && (Ce(e) || w(e) ? F : h).test(we(e));
      var t;
    }
  ...
  o.query(document).on("contextmenu", B), o.query("div", !0).on("drag", B), o.query("div", !0).on("dragstart", B);
  var F = o.query("#materialApp"),
  ...
  function P(e) {
    ...
    return a.node.dataset.value = i, a.node.dataset.parentId = "#materials", a.text(e.name), F.node.scrollTop = F.node.scrollHeight, {
      id: t,
      file: e,
      src: i,
      el: n
  ...
  function O(e) {
    ...
    for (var i = 0; i < e.length; i++) {
      ...
      for (var n = 0; n < b.length; n++) {
        ...
        if (_e56.file.name == _a7.name && _e56.file.lastModified == _a7.lastModified && _e56.file.size == _a7.size && _e56.file.type == _a7.type) {
          _r14 = _e56;
          break;
        }
      }

      if (t.includes(_a7.type)) {
        var _e57 = P(_a7);
  ...
  o.query(".custom-checkbox", !0).on("click", function (e) {
    ...
    t.toggleClass("checked"), o.query(e.target).prop("checked", t.hasClass("checked")), "animateSkin" == e.target.id && (u.animateSkin = t.hasClass("checked")), "autofitSkin" == e.target.id && (u.autofitSkin = t.hasClass("checked")), f.updateSkin(), f.updateBounds();
  });
  ...
  H.on("change", function () {
    ...
    for (var t = 0; t < F.node.children.length; t++) {
      F.node.children[t].classList.remove("selected");
    }
  });
  var D = [];
  ...
  s.on("loadProgress", function (e, t, i) {
    ...
    var e, t, i, n, r, a, o, h, c, d, g, m, y, v, b, k, w, x, S, A, E, C, j, _loop7, T;
                  ...
                  switch (_context.prev = _context.next) {
                    case 0:
                      ...
                      return e.then(function (e) {
                        ...
                        for (var B = 0; B < e.keypoints.length; B++) {
                          var _t29 = e.keypoints[B];
                        ...
                        for (B = 0; B < e.keypoints.length; B++) {
                          var _t30 = e.keypoints[B].position,
                              _i24 = {
                            x: _t30.x - P,
                            y: _t30.y - O
                          };
                        ...
                        for (B = 0; B < e.keypoints.length; B++) {
                          var _t31 = e.keypoints[B].position,
                        ...
                        for (B = 0; B < e.keypoints.length; B++) {
                          ...
                          if (!(_t32.score < .1 && T > 0)) switch (_t32.position.x -= I.width / 2, _t32.position.y -= I.height / 2, "linear" != u.riggingMode && s.emit("changeRiggingMode", "linear"), _t32.part) {
                            ...
                            case "leftAnkle":
                              w = f.moveJointById(w.id, _t32.position.x, _t32.position.y);
                              break;
                        ...
                        var re = b.position.heading(k.position),
                            ae = w.position.dist(k.position) / 4,
                            oe = w.position.x + Math.cos(re) * ae,
                            se = w.position.y + Math.sin(re) * ae;
                        x = f.moveJointById(x.id, oe, se);
                        var le = S.position.heading(A.position),
                            he = E.position.dist(A.position) / 4,
                            ce = E.position.x + Math.cos(le) * he,
                            de = E.position.y + Math.sin(le) * he;

                        if (j = f.moveJointById(j.id, ce, de), C) {
                          var _loop8 = function _loop8() {
                            ...
                            if (i) {
                              ...
                              if (_n27.dist(_r16) > 10 * p.overlayConfigApp.scale) {
                                p.timeline.graph.setCurrentMark(T), p.timeline.graph.updateState(), f.setKeyframe(T), C = JSON.parse(JSON.stringify(e));
                                return "break";
                              }
                            }
                          };

                          for (B = 0; B < C.keypoints.length; B++) {
                            var _ret = _loop8();

                            if (_ret === "break") break;
                          }
                        } else p.timeline.graph.setCurrentMark(T), f.setKeyframe(T), C = JSON.parse(JSON.stringify(e));
                      });
    ...
    for (var r = e.start - 1; r <= e.end - 1; r++) {
      var _t33 = r - e.start + 1,
          _a8 = Math.floor(_t33 % e.cols) * e.cellWidth,
    ...
    i.render(), i.on("finished", function (r) {
      try {
        ...
        var _a9 = n.createWriteStream(e.name + ".gif", {
          size: r.size
        }),
            _o6 = r.stream();

        if (window.WritableStream && _o6.pipeTo) return _o6.pipeTo(_a9);
      } catch (e) {
        console.warn(e);
      }
    });
  ...
  function G(e) {
    ...
    if (e) {
      ...
      var _a10 = t.query("#jointX"),
          _s8 = t.query("#jointY"),
          _l4 = t.query("#jointAngle");

      _a10.value(e.position.x.toFixed(2)), _s8.value(e.position.y.toFixed(2));
      ...
      if (_l4.value(_h4.toFixed(2)), e.skin && (e.skin.imageSrc ? X.removeClass("disabled") : X.addClass("disabled"), e.skin.offset)) {
        ...
        _a11.value(_s9.toFixed(2)), _t36.node._lastValue || (_t36.node._lastValue = _t36.value()), _i28.node._lastValue || (_i28.node._lastValue = _i28.value()), _n30.node._lastValue || (_n30.node._lastValue = _n30.value()), _r18.node._lastValue || (_r18.node._lastValue = _r18.value()), _a11.node._lastValue || (_a11.node._lastValue = _a11.value());
      }
  ...
  X.on("click", function () {
    ...
    e ? (X.removeClass("disabled"), d.loadImage(e).then(function (e) {
      if (t) {
        var _i29 = parseFloat(o.query("#skinPositionX").value()),
            ...
            _a12 = parseFloat(o.query("#skinScaleY").value()),
    ...
    if (t) {
      var _i33 = t.skin,
          ...
          _a13 = parseFloat(o.query("#skinScaleX").value()),
    ...
    A.reset(), S.reset(), x = u.world.zoom;
    ...
    k = !1;
  }), o.query("#fileButton").on("mousedown", function () {
    p.fileApp.hidden ? p.fileApp.show() : p.fileApp.hide();
  }), o.query("#optionButton").on("mousedown", function () {
    p.optionApp.hidden ? p.optionApp.show() : p.optionApp.hide();
  }), o.query("#fileButton").on("mouseenter", function () {
    p.optionApp.hidden || (p.optionApp.hide(), p.fileApp.show());
  }), o.query("#optionButton").on("mouseenter", function () {
    p.fileApp.hidden || (p.fileApp.hide(), p.optionApp.show());
  }), addEventListener("mousedown", function (e) {
    "fileButton" != e.target.id && p.fileApp.hide(), "optionButton" != e.target.id && p.optionApp.hide();
  }), c.on("keydown", function (e) {
    var t = C[j[e.code]];
    if (t && "input" != document.activeElement.tagName.toLowerCase() && (q(t), I = t), e.ctrlKey && (90 == e.keyCode && s.emit("undo"), 89 == e.keyCode && s.emit("redo")), e.shiftKey && I == C.add && f.activeJoint && (w || (w = f.activeJoint)), 32 == e.keyCode && "input" != document.activeElement.tagName.toLowerCase() && I != C.pan && (Z = I, q(C.pan)), 46 == e.keyCode) if ("joints" == v) {
    ...
    p.contextMenuApp.hide(), L.css("display", "none");
  }), h.on("mousemove", function () {
    h.dragged || A.set(E), h.x <= a.bounds.x || h.x >= a.bounds.x + a.bounds.width || h.y <= a.bounds.y || h.y >= a.bounds.y + a.bounds.height ? Q.css("display", "none") : Q.css({
      display: "block",
      top: h.y - 10 + "px",
      left: h.x + 9 + "px"
    });
  ...
  a.canvas.addEventListener("mousemove", function (e) {
    h.dragged && !k && I === C.pan && (S.set({
      x: A.x - E.x + a.camera.movement.x,
      y: A.y - E.y + a.camera.movement.y
    }), S.x = d.clamp(S.x, -9e3, 9e3), S.y = d.clamp(S.y, -9e3, 9e3)), I !== C.move || k || h.pressed && (v = "joints", f.moveJoint(E.x, E.y));
    ...
    if (p.overlayApp.hidden && p.overlayConfigApp.hidden && p.fileApp.hidden && p.loadApp.hidden && p.saveApp.hidden && p.optionApp.hidden) {
      if (I == C.add) {
        if (w) {
          var _e64 = f.activeJoint.position.x - E.x + w.position.x,
              _t44 = f.addJoint(_e64, E.y, {
            parent: w,
            ignoreHistory: !0,
            ignoreDefaults: !0
          });
        ...
        f.addJoint(E.x, E.y), v = "joints";
      }

      I === C.remove && (f.selectJoint(E.x, E.y), f.removeJointByPosition(E.x, E.y), v = "joints"), I === C.select && (f.selectJoint(E.x, E.y), v = "joints");
    }
  }), a.canvas.addEventListener("mousewheel", function () {
    h.scrollTop ? x -= 100 : x += 100, x = d.clamp(x, u.world.minZoom, u.world.maxZoom);
  ...
  a.draw(function () {
    ...
    E.set(a.camera.screenToWorld(h.x - a.bounds.x, h.y - a.bounds.y)), a.rect(0, 0, a.bounds.width, a.bounds.height, {
      fill: u.world.background
    }), a.camera.begin(function () {
      a.camera.moveTo(S.x, S.y), a.camera.zoomTo(x);
      ...
      if (o && (a.save(), a.context.globalAlpha = p.overlayConfigApp.opacity, a.context.scale(p.overlayConfigApp.scale, p.overlayConfigApp.scale), a.context.rotate(p.overlayConfigApp.angle), a.context.drawImage(o, -o.width / 2, -o.height / 2), a.restore()), e && I === C.add) {
        var _e65 = "rgba(240, 230, 255, 0.75)";
        a.save(), a.context.globalCompositeOperation = "overlay";
        var _t45 = f.activeJoint;

        if (_t45 && (a.line(E.x, E.y, _t45.position.x, _t45.position.y, {
          lineWidth: u.render.segment.width,
          lineCap: "round",
          stroke: _e65
        }), w)) {
          var _i35 = _t45.position.x - E.x + w.position.x;

          a.line(_i35, E.y, w.position.x, w.position.y, {
            lineWidth: u.render.segment.width,
            lineCap: "round",
            stroke: _e65
          }), a.circle(_i35, E.y, u.render.joint.radius, {
            fill: _e65
          });
        }

        a.circle(E.x, E.y, u.render.joint.radius, {
          fill: _e65
        }), a.restore();
      }
      ...
      if (ie.prop("checked")) {
        ...
        for (var s = -x - _e66; s < x + _e66; s += _t46) {
        ...
        for (var l = -x - _e66; l < x + _e66; l += _t46) {
    ...
    var o = r || "MozAppearance" in document.documentElement.style ? "iframe" : "navigate",
      ...
      createWriteStream: function createWriteStream(n, h, c) {
        ...
        if (Number.isFinite(h) ? ((_ref2 = [h, c], c = _ref2[0], h = _ref2[1], _ref2), console.warn("[StreamSaver] Depricated pass an object as 2nd argument when creating a write stream"), d.size = c, d.writableStrategy = h) : h && h.highWaterMark ? (console.warn("[StreamSaver] Depricated pass an object as 2nd argument when creating a write stream"), d.size = c, d.writableStrategy = h) : d = h || {}, !a) {
          ...
          d.size && (_a14.headers["Content-Length"] = d.size);
          var _h5 = [_a14, "*", [f.port2]];
  ...
  (function (e) {
    ...
    l.prototype.slice = function (e, t) {
      ...
      return e = +e, t |= 0, i || q(this, e, t, 2, 65535, 0), l.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8) : B(this, e, t, !0), t + 2;
    }, l.prototype.writeUInt16BE = function (e, t, i) {
      return e = +e, t |= 0, i || q(this, e, t, 2, 65535, 0), l.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 8, this[t + 1] = 255 & e) : B(this, e, t, !1), t + 2;
    }, l.prototype.writeUInt32LE = function (e, t, i) {
      return e = +e, t |= 0, i || q(this, e, t, 4, 4294967295, 0), l.TYPED_ARRAY_SUPPORT ? (this[t + 3] = e >>> 24, this[t + 2] = e >>> 16, this[t + 1] = e >>> 8, this[t] = 255 & e) : F(this, e, t, !0), t + 4;
    }, l.prototype.writeUInt32BE = function (e, t, i) {
      return e = +e, t |= 0, i || q(this, e, t, 4, 4294967295, 0), l.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e) : F(this, e, t, !1), t + 4;
      ...
      return e = +e, t |= 0, i || q(this, e, t, 2, 32767, -32768), l.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8) : B(this, e, t, !0), t + 2;
    }, l.prototype.writeInt16BE = function (e, t, i) {
      return e = +e, t |= 0, i || q(this, e, t, 2, 32767, -32768), l.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 8, this[t + 1] = 255 & e) : B(this, e, t, !1), t + 2;
    }, l.prototype.writeInt32LE = function (e, t, i) {
      return e = +e, t |= 0, i || q(this, e, t, 4, 2147483647, -2147483648), l.TYPED_ARRAY_SUPPORT ? (this[t] = 255 & e, this[t + 1] = e >>> 8, this[t + 2] = e >>> 16, this[t + 3] = e >>> 24) : F(this, e, t, !0), t + 4;
    }, l.prototype.writeInt32BE = function (e, t, i) {
      return e = +e, t |= 0, i || q(this, e, t, 4, 2147483647, -2147483648), e < 0 && (e = 4294967295 + e + 1), l.TYPED_ARRAY_SUPPORT ? (this[t] = e >>> 24, this[t + 1] = e >>> 16, this[t + 2] = e >>> 8, this[t + 3] = 255 & e) : F(this, e, t, !1), t + 4;
                ...
                return _context3.abrupt("return", (s = s.slice(l - 1), l = 0, '"' === s.charAt(0) && '"' === s.charAt(1) ? (s = s.slice(2), l = 0, "") : (u(), function () {
                  ...
                  for (i = e.indexOf("\\"); i >= 0;) {
                    ...
                    if (l = i, h = e.charAt(++l), "u" === h) {
                      for (_a15 = 0, _r22 = 0; _r22 < 4 && (_n37 = parseInt(h = e.charAt(++l), 16), isFinite(_n37)); _r22 += 1) {
                        _a15 = 16 * _a15 + _n37;
                      }

                      e = e.slice(0, i) + String.fromCharCode(_a15) + e.slice(i + 6), l = i;
                    } else {
          ...
          this._hasProperty(t, "curve", function () {
            ...
            for (var o = 1; o < e.length; o++) {
              var _t54 = e[o],
                  ...
                  _a16 = .5 * (_i38.y + _t54.y);

              n.quadraticCurveTo(_t54.x, _t54.y, _r23, _a16);
            }
